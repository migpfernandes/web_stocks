            ...
            <div id="mainmenu">
                ...
                $this->widget('zii.widgets.CMenu', array(
                    'items' => array(
                        ...
                        array('label' => 'Produtos', 'url' => array('/produto')),
                        array('label' => 'Clientes/Fornecedores', 'url' => array('/entidade')),
                        array('label' => 'Obras', 'url' => array('/obra')),
                        array('label' => '|', 'url' => array('#')),
...
<?php echo $content; ?>
            ...
            <div id="footer">
                Copyright &copy; <?php echo date('Y'); ?> <a href="malito:miguelpintodacosta@gmail.com">Miguel Costa</a> and <a href="malito:migpfernandes@gmail.com">Miguel Fernances</a>.<br/>
